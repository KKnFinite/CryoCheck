...
def settings():
    ...
    if form.validate_on_submit():
        ...
        if form.min_type1_gallons.data is not None:
            personal_settings.min_type1_gallons = form.min_type1_gallons.data
        if form.min_type4_gallons.data is not None:
            personal_settings.min_type4_gallons = form.min_type4_gallons.data
