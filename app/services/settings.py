...
from app.services.type4_fluids import TYPE4_FLUID_PROFILES


TYPE1_FLUID_OPTIONS: Final[tuple[str, ...]] = tuple(TYPE1_FLUID_PROFILES)
TYPE4_FLUID_OPTIONS: Final[tuple[str, ...]] = tuple(TYPE4_FLUID_PROFILES)
...
class SettingsDefinition:
    ...
    min_type1_gallons: Decimal
    min_type4_gallons: Decimal
...
DEFAULT_SETTINGS: Final = SettingsDefinition(
    ...
    type4_fluid=TYPE4_FLUID_OPTIONS[0],
    allowed_gap_minutes=5,
    max_type1_rate_gpm=Decimal("60"),
    max_type4_rate_gpm=Decimal("30"),
    min_type1_gallons=Decimal("1"),
    min_type4_gallons=Decimal("5"),
...
def default_model_values() -> dict[str, object]:
    ...
    return {
        ...
        "min_type1_gallons": DEFAULT_SETTINGS.min_type1_gallons,
        "min_type4_gallons": DEFAULT_SETTINGS.min_type4_gallons,
...
def settings_for_user(user: User) -> SettingsDefinition:
    ...
    return SettingsDefinition(
        ...
        min_type1_gallons=settings.min_type1_gallons,
        min_type4_gallons=settings.min_type4_gallons,
